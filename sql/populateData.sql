...
VALUES 
  (1, '10-12', 1, ST_SetSRID(ST_MakePoint(0, 0), 4326), '2023-01-01 10:00:00', (SELECT id FROM users WHERE username = 'Marino')),
  (1, '10-12', 1, ST_SetSRID(ST_MakePoint(1, 1), 4326), '2023-02-15 14:30:00', (SELECT id FROM users WHERE username = 'Dario')),
  (2, '10-12', 1, ST_SetSRID(ST_MakePoint(2, 2), 4326), '2023-03-20 09:00:00', (SELECT id FROM users WHERE username = 'Lovro')),
  (3, '13-15', 2, ST_SetSRID(ST_MakePoint(3, 3), 4326), '2023-04-25 11:00:00', (SELECT id FROM users WHERE username = 'Jelena')),
  (4, '16-18', 3, ST_SetSRID(ST_MakePoint(4, 4), 4326), '2023-05-30 12:00:00', (SELECT id FROM users WHERE username = 'User1')),
  (5, '19-21', 4, ST_SetSRID(ST_MakePoint(5, 5), 4326), '2023-06-05 13:00:00', (SELECT id FROM users WHERE username = 'User2'));
